...
const SalaryCreate = () => {
    ...
    // Effect: Auto-fetch employee salary and calculate days in month
    useEffect(() => {
    ...
    useEffect(() => {
        if (salaryDate) {
            ...
            setDaysInMonth(days);
            // Default days present to days in month if not set or if it exceeds
            if (daysPresent > days || daysPresent === 0) {
                setDaysPresent(days);
            }
        }
    }, [salaryDate]);
    ...
    const handleSave = (status = 'Draft') => {
        ...
        console.log('Saving Salary:', salaryData);
        showToast.success(`Salary entry ${status === 'Paid' ? 'completed' : 'saved'} successfully!`);
        navigate('/salary');
    };
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
            <div className="max-w-8xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Create Salary Entry</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Manage employee salary, deductions, and extras</p>
                    </div>
                </div>
