...
const EmployeeEditModal = ({ isOpen, onClose, employee }) => {
    ...
    useEffect(() => {
        if (employee) {
            ...
            const permissionsObj = {
                pos: employee.permissions.includes('pos'),
                purchase: employee.permissions.includes('purchase'),
                finance: employee.permissions.includes('finance')
            };
            ...
            setFormData({
                ...
                pin: employee.pin || '', // Pre-fill if available, or leave blank if hidden
    ...
    const handleSubmit = (e) => {
        ...
        if (validate()) {
            ...
            console.log('Updating Employee:', submitData);
