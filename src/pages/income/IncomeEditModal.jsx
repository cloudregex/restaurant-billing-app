...
const IncomeEditModal = ({ isOpen, onClose, income }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (validate()) {
            console.log('Updating Income:', formData);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl animate-scale-in max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white">Edit Income</h2>
                    <UniversalButton
                        onClick={onClose}
                        variant="text"
                        color="gray"
