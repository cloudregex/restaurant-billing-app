        ...
        <div className={`${className}`}>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    disabled={disabled}
                    required={required}
                    className={`w-full py-2 border rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 ${leftIcon ? 'pl-10' : 'px-3'} ${rightIcon ? 'pr-10' : 'px-3'} ${error
